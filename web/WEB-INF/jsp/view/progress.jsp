    ...
    <div class='col-md-6'>
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form role="form" action="/progress" method="GET">
            <fieldset>
              <div class="row">
                <div class="col-sm-12 col-md-10  col-md-offset-1 ">

                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="datepicker-month"></label>
                    <div class="col-sm-12">
                      <div class="input-append date" id="datepicker-month" data-date-format="yyyy-mm" data-date="2017-01">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                      <div class="input-group">
                        <input name="View Progress" type="submit" value="<spring:message code="view.progress"/>" />
                      </div>
                    </div>
                  </div>
